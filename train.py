...
if __name__=='__main__':
    ...
    SEQ_LEN = 200
    train_sentences = pad_sequences(train_sequenceses, SEQ_LEN)
    val_sentences = pad_sequences(val_sequenceses, SEQ_LEN)
    ...
    modl = SentimentNet(output_size, embedding_matrix, hidden_dim, n_layers)
